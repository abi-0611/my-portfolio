...
const MagicBento = ({
  ...
  const baseCardClassName = `magic-bento-card ${textAutoHide ? "magic-bento-card--text-autohide" : ""} ${enableBorderGlow ? "magic-bento-card--border-glow" : ""}`;
  ...
  return (
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {enableStars
          ? // Wrap each child in a ParticleCard
